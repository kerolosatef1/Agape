...
import { HandCoins, FileText, DollarSign, Pencil, BookOpen } from "lucide-react";
import { useTranslations } from "next-intl";
import { toast } from "react-toastify";
import { editWithdrawFormAction, WithdrawActionState } from "../action/budget-withdraw.action";
...
interface EditWithdrawDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  budget: IBudgetWithdraw | null;
}

const EditWithdrawDialog: React.FC<EditWithdrawDialogProps> = ({
  open,
  onOpenChange,
  budget,
}) => {
  ...
  const [state, formAction] = useActionState(editWithdrawFormAction, initialState);
  ...
  const onSubmit: SubmitHandler<TWithdrawInput> = (data) => {
    ...
    fd.append("budgetWithdrawId", String(budget.budgetWithdrawId));
...
export default EditWithdrawDialog;